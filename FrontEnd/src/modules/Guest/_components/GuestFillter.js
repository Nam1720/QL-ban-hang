...
const GuestFillter = () => {
  ...
  return (
    <div className='d-flex align-items-center justify-content-between' style={{ width: '50%' }}>
      <Input onChange={e => handleChangeInput(e.target.value)} addonAfter={loading ? <LoadingOutlined /> : <SearchOutlined />} placeholder="Theo mã, tên, điện thoại" style={{ width: '70%' }} allowClear />
